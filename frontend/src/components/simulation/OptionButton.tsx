...
export default function OptionButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`font-shark w-full max-w-md rounded-xl flex justify-center items-center text-center text-3xl font-semibold shadow-xl transition ${colorMap[color]} `}
    >
      {children}
    </button>
  );
