...
export default function RecordWavPCM16() {
...
//   // presigned-url 요청 후 WAV 업로드 
//   const uploadToS3 = async (wavBlob: Blob) => {
//   try {
//     // presigned-url 발급 요청
//     const res = await fetch("https://fdmkozia90.execute-api.ap-northeast-2.amazonaws.com/presigned-url", {
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
//       body: JSON.stringify({
//         fileName: `session_answers/3/audio_${Date.now()}.wav`, 
//         operation: "putObject", 
...
//     console.log("업로드 대상 S3 경로:", fileName);
