...
public class ScenarioUpdateRequest {
    ...
    @Schema(description = "썸네일 S3 키 (변경하지 않으려면 null)", example = "scenarios/thumbnails/uuid_image.jpg")
    private String thumbnailS3Key;

    @Schema(description = "배경 이미지 S3 키 (변경하지 않으려면 null)", example = "scenarios/backgrounds/uuid_image.jpg")
    ...
    private List<SequenceUpdateRequest> sequences;
}